...
def convert(currency_from, currency_to, amnt, replace_commas=True) -> str:
    """
    Used to convert amount from one currency to another
    Currency code from which amount needs to be converted
    Currency code in which amount needs to be converted to
    which needs to be converted
    If True than the commas will be removed from converted amount and the converted amount will
